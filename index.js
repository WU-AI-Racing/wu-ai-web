...
function showapplications() {
    $("#applications_container").css("display","inherit");
    $("#applications_container").addClass("animated slideInLeft");
    setTimeout(function(){
        $("#applications_container").removeClass("animated slideInLeft");
    },800);
}

function closeapplications() {
    $("#applications_container").addClass("animated slideOutLeft");
    setTimeout(function(){
        $("#applications_container").removeClass("animated slideOutLeft");
        $("#applications_container").css("display","none");
    },800);}
